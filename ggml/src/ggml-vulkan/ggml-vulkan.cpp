...
//    VkBool32 enable_best_practice = layer_settings;
    ...
    // Validation layer disabled - Debian Vulkan.hpp 1.3.239 too old (missing VK_EXT_layer_settings)
    VkBool32 enable_best_practice = VK_FALSE;
    std::ignore = enable_best_practice;
